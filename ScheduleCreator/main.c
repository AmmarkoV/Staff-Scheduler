...
int SC_Test()
{
  ...
  /*
      ...
      SC_AddJob("ΠΥΡΣΕΙΑ",1); // 10
      SC_AddJob("ΥΕΣΑ",1); // 11
      SC_AddJob("ΑΥΔΜ 12ΛΔΒ",1); // 12
      SC_AddJob("ΑΥΔΜ ΚΕΠΙΚ",1); // 13


      SC_AddPerson("Κανένας"," ",0,0); // 0
      SC_AddPerson("ΓΚΑΜΑΖ","ΑΜΜΑΡ",0,14); // 1
      SC_AddPerson("ΜΠΑΧΤΣΕΒΑΝΙΔΗΣ","ΟΝΟΜΑ",0,14); //  2
      SC_AddPerson("ΓΑΛΑΤΟΥΔΗΣ","ΟΝΟΜΑ",0,14); // 3

      SC_AddPerson("ΟΙΚΟΝΟΜΟΥ","ΟΝΟΜΑ",0,14); // 4
      SC_AddPerson("ΧΑΡΙΣΙΔΗΣ","ΟΝΟΜΑ",0,14); //  5
      SC_AddPerson("ΣΤΟΥΓΙΑΝΝΗΣ","ΟΝΟΜΑ",0,14); // 6
      SC_AddPerson("ΚΑΤΣΙΚΑΔΑΚΟΣ","ΟΝΟΜΑ",0,14); // 7
      SC_AddPerson("ΦΟΥΝΤΟΥΛΑΚΗΣ","ΟΝΟΜΑ",0,14); // 8


      SC_AddPerson("ΣΑΡΡΗΣ","ΟΝΟΜΑ",0,14); // 9
      SC_AddPerson("ΜΑΝΙΑΤΗΣ","ΟΝΟΜΑ",0,14); // 10
      SC_AddPerson("ΚΑΝΕΛΛΟΠΟΥΛΟΣ","ΟΝΟΜΑ",0,14); // 11
      SC_AddPerson("ΠΛΑΤΑΝΗΤΗΣ","ΟΝΟΜΑ",0,14); // 12
      SC_AddPerson("ΧΟΥΜΟΣ","ΟΝΟΜΑ",0,14); // 13
      SC_AddPerson("ΒΛΑΧΑΚΗΣ","ΟΝΟΜΑ",0,14); //  14
      SC_AddPerson("ΧΡΙΣΤΟΠΟΥΛΟΣ","ΟΝΟΜΑ",0,14); // 15
      SC_AddPerson("ΝΙΚΗΤΑΚΗΣ","ΟΝΟΜΑ",0,14); // 16
      SC_AddPerson("ΔΙΑΚΙΔΗΣ","ΟΝΟΜΑ",0,14); // 17

      SC_AddPerson("ΚΑΤΣΙΚΑΣ","ΟΝΟΜΑ",0,14); // 18
      SC_AddPerson("ΜΗΧΑΛΑΤΟΣ","ΟΝΟΜΑ",0,14); //  19
      SC_AddPerson("ΠΑΤΣΑΚΗΣ","ΟΝΟΜΑ",0,14); // 20
      SC_AddPerson("ΠΑΡΑΣΚΕΥΑΣ","ΟΝΟΜΑ",0,14); // 21
      SC_AddPerson("ΚΑΡΓΑΚΟΣ","ΟΝΟΜΑ",0,14); // 22


      SC_AddPerson("ΑΡΑΟΥΖΟΣ","ΟΝΟΜΑ",0,14); //  23
      SC_AddPerson("ΠΑΠΑΠΑΝΑΓΙΩΤΟΥ","ΟΝΟΜΑ",0,14); // 24
